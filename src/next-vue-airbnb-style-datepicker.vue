...
export default /*#__PURE__*/defineComponent({
  name: 'NextVueAirbnbStyleDatepicker', // vue component name
  data(): SampleData {
    return {
      counter: 5,
      initCounter: 5,
...
<template>
  <div class="next-vue-airbnb-style-datepicker">
...
<style scoped>
  .next-vue-airbnb-style-datepicker {
    display: block;
    width: 400px;
    margin: 25px auto;
  ...
  .next-vue-airbnb-style-datepicker p {
    margin: 0 0 1em;
  }
</style>
